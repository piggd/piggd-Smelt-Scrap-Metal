...
private["_hasboiledbottleitem","_hasbottleitem","_itemsremoved","_hasitems","_bottletext","_item1text","_parttext","_itemtext","_waterbottleqty","_reqitemqty","_item1qty","_itemsreq","_dis","_sfx"];
